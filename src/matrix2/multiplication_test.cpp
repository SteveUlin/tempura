...
auto main() -> int {
  "Basic Multiplication"_test = [] {
    constexpr matrix::InlineDense<double, 2, 2> m{
        {0., 1.},
        {2., 3.},
    };
    constexpr matrix::InlineDense<double, 2, 2> n{
        {4., 5.},
        {6., 7.},
    };
    constexpr matrix::InlineDense<double, 2, 2> o{
        {6., 7.},
        {26., 31.},
    };
    static_assert(m * n == o);
  ...
  "Distinct Size Multiplication"_test = [] {
    ...
    constexpr matrix::InlineDense<double, 3, 2> n{
        {6., 7.},
        {8., 9.},
        {10., 11.},
    };
